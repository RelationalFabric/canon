...
- `07-custom-axioms-example/custom-axioms.ts`
- `07-custom-axioms-example/custom-functions.ts`
- `07-custom-axioms-example/usage.ts`

## File: `07-custom-axioms-example/business-scenarios.ts`
