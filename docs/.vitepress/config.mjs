...
// All links are expressed relative to the site base '/', matching repo-root relative paths.
export default {
  srcDir: '.',
  base: '/',
  title: 'Canon',
  ...
  themeConfig: {
    nav: [
      ...
      // Assets in docs/public are served at the site root '/'
      { text: 'Radar', link: '/radar/radar.html' }
    ],
    sidebar: {
      '/adrs/': [
        {
