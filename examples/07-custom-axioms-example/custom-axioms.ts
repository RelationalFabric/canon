...
import { declareCanon, pojoWithOfType, inferAxiom } from '@relational-fabric/canon'
...
export type { EmailAxiom, CurrencyAxiom, StatusAxiom, PriorityAxiom, EcommerceWithCustomAxioms }